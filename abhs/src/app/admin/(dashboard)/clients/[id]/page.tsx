...
import { ArrowLeft, Calendar, MapPin, Briefcase, ClipboardList } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <div>
          <Link href="/admin/clients" className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-brand-600 mb-2">
