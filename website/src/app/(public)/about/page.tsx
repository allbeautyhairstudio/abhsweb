...
export default function AboutPage() {
  return (
    <div className="flex flex-col">
      ...
      {/* Atmospheric image break — the turning point */}
      <section className="relative h-64 sm:h-80">
        <Image
          src="/journey/banner-03.webp"
          alt="Collage of Karli's studio and work"
          fill
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            <FloralBloom className="w-6 h-6 text-white/40 mx-auto mb-3" />
            <p className="font-serif text-xl sm:text-2xl text-white text-center px-6 max-w-xl leading-relaxed italic">
              &ldquo;I took it minute by minute, hour by hour, day by day.&rdquo;
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Image break — Karli's artistry */}
      <section className="relative h-64 sm:h-80">
        <Image
          src="/journey/banner-02.webp"
          alt="Collage of Karli's hair color work — natural tones"
          fill
          className="object-cover object-center"
          sizes="100vw"
        />
        <div className="absolute inset-0 bg-warm-800/15" />
      </section>
      ...
      {/* Closing floral */}
      <FloralDivider className="text-forest-500 pb-8 px-4" />
    </div>
  );
}
