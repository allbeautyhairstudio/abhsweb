...
import { FloralBloom, FloralDivider, FloralCorner, FloralWatercolorBg } from '@/components/decorative/floral-accents';
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative py-16 sm:py-20 overflow-hidden">
        <FloralWatercolorBg className="absolute inset-0 w-full h-full" />
