...
import { getDeliverablesByClientId } from '@/lib/queries/deliverables';
import { getPromptsByClientId } from '@/lib/queries/prompts';
...
export async function GET(
  ...
  try {
    ...
    const generatedPrompts = getPromptsByClientId(numId);
