...
export const SALON_PIPELINE_STAGES = PIPELINE_STAGES;
export type SalonPipelineStage = PipelineStage;
...
export const SALON_STAGE_CHECKLISTS = STAGE_CHECKLISTS;
...
export const SALON_DELIVERABLE_TYPES = DELIVERABLE_TYPES;
